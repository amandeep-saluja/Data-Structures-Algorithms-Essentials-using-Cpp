...
public:
    ...
    */
    ...
    // Destructor -> will release the references and variables
    ~Product()
    {
        cout << "Deleting " << name << endl;

        // Should release the dynamically created memory manually before destructure the object to avoid memory leak
        if (name != NULL)
        {
            delete[] name;
            name = NULL;
